# TGR vs BPM — conflict report (heuristic)

- TGR root: `C:/Users/Andrey/Projects/vic3_mods/.TheGreatRevision`
...
- Total overlapping files: **45**
- Load order note: if `BPM` loads after `TGR`, `BPM` wins on these files.

### common/* file overlaps — 4
- **common/decisions**: 1
...
- **gfx**: 41
  - `gfx/coat_of_arms/textured_emblems/te_coa_milan.dds`
  - `gfx/coat_of_arms/textured_emblems/te_coa_rome.dds`
  - `gfx/event_pictures/americaya.dds`
  - `gfx/interface/icons/1x1.dds`
  - `gfx/interface/icons/law_icons/all_parties_allowed.dds`
  - `gfx/interface/icons/law_icons/banned_template.dds`
  - `gfx/interface/icons/law_icons/centralization.dds`
  - `gfx/interface/icons/law_icons/clock_template.dds`
  - `gfx/interface/icons/law_icons/confederated.dds`
  - `gfx/interface/icons/law_icons/devolved.dds`
  - `gfx/interface/icons/law_icons/disability_insurance.dds`
  - `gfx/interface/icons/law_icons/elected_officers.dds`
  - `gfx/interface/icons/law_icons/elected_police.dds`
  - `gfx/interface/icons/law_icons/gun.dds`
  - `gfx/interface/icons/law_icons/land_based_taxation.dds`
  - `gfx/interface/icons/law_icons/limited_unions.dds`
  - `gfx/interface/icons/law_icons/limited_work_hours.dds`
  - `gfx/interface/icons/law_icons/mass_conscription.dds`
  - `gfx/interface/icons/law_icons/moderates_only.dds`
  - `gfx/interface/icons/law_icons/no_income_tax.dds`
  - `gfx/interface/icons/law_icons/noble_officers.dds`
  - `gfx/interface/icons/law_icons/olive_template.dds`
  - `gfx/interface/icons/law_icons/politicized_officers.dds`
  - `gfx/interface/icons/law_icons/professional_officers.dds`
  - `gfx/interface/icons/law_icons/purchased_officers.dds`
  - `gfx/interface/icons/law_icons/reactionary_parties_banned.dds`
  - `gfx/interface/icons/law_icons/reactionary_parties_only.dds`
  - `gfx/interface/icons/law_icons/right_to_rest.dds`
  - `gfx/interface/icons/law_icons/rose.dds`
  - `gfx/interface/icons/law_icons/single_party.dds`
  - `gfx/interface/icons/law_icons/socialist_parties_banned.dds`
  - `gfx/interface/icons/law_icons/socialist_parties_only.dds`
  - `gfx/interface/icons/law_icons/socialist_unions_only.dds`
  - `gfx/interface/icons/law_icons/state_controlled_union.dds`
  - `gfx/interface/icons/law_icons/suffrage.dds`
  - `gfx/interface/icons/law_icons/syndicalism.dds`
  - `gfx/interface/icons/law_icons/token_time_regulations.dds`
  - `gfx/interface/icons/law_icons/unitary.dds`
  - `gfx/interface/icons/law_icons/universal_suffrage.dds`
  - `gfx/interface/icons/law_icons/unregulated_work_time.dds`
  - `gfx/interface/icons/law_icons/violent_suppresion.dds`
