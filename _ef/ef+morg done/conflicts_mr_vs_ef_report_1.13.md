...
- `on_five_year_pulse_country`
  ...
  - Morgenrote: `common/on_actions/mr_science_lepsius_on_actions.txt`
  - Morgenrote: `common/on_actions/mr_science_verrier_on_actions.txt`
  - Morgenrote: `common/on_actions/mr_sports_vikelas_on_actions.txt`
  - E&F: `common/on_actions/00_ef_on_action.txt`
- `on_game_started_after_lobby`
  - Morgenrote: `common/on_actions/mr_on_actions.txt`
  - E&F: `common/on_actions/00_ef_on_action.txt`
- `on_half_yearly_pulse_country`
  - Morgenrote: `common/on_actions/mr_ai_on_actions.txt`
  - Morgenrote: `common/on_actions/mr_arts_gaudi_on_actions.txt`
  - Morgenrote: `common/on_actions/mr_on_actions.txt`
  - Morgenrote: `common/on_actions/mr_science_academics_on_actions.txt`
  - Morgenrote: `common/on_actions/mr_science_dubois_on_actions.txt`
  - E&F: `common/on_actions/00_ef_on_action.txt`
