...
<!-- meta
пара: LLWA × Morgenröte × E&F
статус: done
версии: Game 1.13 (exe 1.13.11) — Locomotion (LLWA) 2.6.3, Morgenroete, LLWA + Morgenroete Compatch 1.0.8, Economic and Financial Mod (E&F) - V4.
позиция: —
файлов: 1
генератор: tools/regen_llwa_morg_ef.py
зависит от: —
-->
