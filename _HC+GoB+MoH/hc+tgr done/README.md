...
Built 24.08.2026 against [b]TGR 2.0 (1.13.10)[/b], [b]Hail, Columbia! 8.6-Roosevelt[/b], [b]Gates of the Bosphorus 4.0.8[/b] and [b]Mandate of Heaven 1.4.6.1[/b].
...
[list]
[*]TGR reworks [i]ig_landowners[/i] and [i]ig_rural_folk[/i] with [i]REPLACE_OR_CREATE:[/i] from its own files. Hail, Columbia! ships [i]common/interest_groups/00_landowners.txt[/i] and [i]00_rural_folk.txt[/i] - the vanilla paths, bare bodies - and loads later, so both of TGR's versions are gone entirely.
